...
public class EFlyingEye extends Enemy {
	private int bulletDelayTick = 0;
	private GameLogic gameLogic;
	private double startingX;

	public EFlyingEye(GameLogic gameLogic, double x) {
		super(800, 0.5);
		// TODO Auto-generated constructor stub
		this.width = RenderableHolder.eFlyingEye.getWidth();
		this.height = RenderableHolder.eFlyingEye.getHeight();
		this.visible = true;
	...
	public void draw(GraphicsContext gc) {
		...
		gc.drawImage(RenderableHolder.eFlyingEye, x, y);
		if(collided) {
